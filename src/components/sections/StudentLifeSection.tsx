...
const CAMPUS_LIFE_CARDS = [
  {
    ...
    description: "Bose, Azad, Bhagat, and Patel Houses compete in annual sports, debates, and cultural showcases.",
    image: "https://images.unsplash.com/photo-1526976668912-1a811878dd37?auto=format&fit=crop&q=80&w=1000",
    badge: "Inter-House Championship",
    icon: ShieldCheckIcon,
  },
  {
    id: "computer-lab-guild",
    category: "TECHNOLOGY & IT",
    title: "Computer & IT Guild",
    tagline: "Coding · Literacy · Skills",
    description: "Students learn essential computer applications, coding fundamentals, typing, and digital creativity in our modern computer laboratory.",
